...
const projects =[
    ...
    image: `${import.meta.env.BASE_URL}Projects/buildboxpic.png`,
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}Projects/portfoliopic.png`,
  ...
  },
  {
    ...
    Description: "A inovative cloud type service that serves connection between devices - SERVER",
    image: `${import.meta.env.BASE_URL}Projects/mycloud-server.jpg`,
    tags: ["React", "JSON"],
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}Projects/mycloud-client.jpg`,
